...
$search_input = filter_input_array(INPUT_POST);
$so_no = $search_input["so_no"];
$po_no = $search_input["po_no"];
//$cust_id = $search_input["cust_id"];

$search_order = filter_input(INPUT_GET, "search_order");

if ($so_no != "") {
    $array_where["where"] = " AND so_no = '$so_no' ";
} else if ($search_order != "") {
    $so_no = $search_order;
    $array_where["where"] = " AND so_no = '$search_order' ";
}

if ($so_no != "") {
    $master_result = PackingSlip::searchPackingSlip($array_where);
    $customer_id = $master_result["cust_id"];
    $packingslip_detail_master = PackingSlip::packingSlipDetails($master_result["ps_id"]);
    ...
    $inProgressOrders = PackingSlip::otherInProgressOrdersForCustomer($master_result["cust_id"], "inprogres");
    $deliveredOrders = PackingSlip::otherInProgressOrdersForCustomer($master_result["cust_id"], "neworders");
    $tracking = PackingSlip::tracking($so_no);
    $tracking_phase = PackingSlip::trackingPhase($master_result["prof_id"]);
}

//$searchNumbersFromPackingSlip = PackingSlip::searchNumbersFromPackingSlip();
?>
...
<div class="card mb-4">
    <div class="card-body">
        <a href="#" class="btn btn-label-secondary" ><i class="bx bx-recycle"></i>&nbsp;Confirm</a>
        <a href="../roundwrap/download/packingslip/<?php echo $so_no ?>_packingslip.pdf" class="btn btn-label-secondary"  target="_blank" ><i class="bx bx-printer"></i>&nbsp;Print</a>
        <a href="../roundwrap/download/packingslipakg/<?php echo $so_no ?>_acknowledgement.pdf" class="btn btn-label-secondary" target="_blank"><i class="bx bx-printer"></i>&nbsp;Print Ack</a>
        <a href="#" class="btn btn-label-secondary" ><i class="bx bx-mail-send"></i>&nbsp;Email</a>
        &nbsp;|&nbsp;
        <a href="#" class="btn btn-label-secondary" ><i class="bx bx-dollar"></i>&nbsp;Quote</a>
        <a href="#" class="btn btn-label-secondary" ><i class="bx bx-notepad"></i>&nbsp;Mediator</a>
        <a href="#" class="btn btn-label-secondary" ><i class="bx bx-barcode"></i>&nbsp;Work Order</a>
        &nbsp;|&nbsp;
        <a href="#" class="btn btn-label-secondary" ><i class="bx bx-pen"></i>&nbsp;Edit</a>
        <a href="index.php?pagename=create_notes&search_order=<?php echo $so_no ?>&criteria=note" class="btn btn-label-secondary" ><i class="bx bx-note"></i>&nbsp;Note</a>
        &nbsp;|&nbsp;
        <a href="index.php?pagename=create_notes&search_order=<?php echo $so_no ?>&criteria=delete_order" class="btn btn-label-danger" ><i class="bx bx-trash"></i>&nbsp;Delete</a>
    </div>
</div>

<?php if ($so_no != "" && $master_result["so_no"] == $so_no) { ?>
    <div class="row gy-4">
        <!-- User Sidebar -->
                    ...
                    <div class="d-flex justify-content-around flex-wrap my-4 py-3">
                        <table class="table table-borderless" style="text-align: center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?pagename=searchdisplay_customermaster&customerid=<?php echo $customer_id ?>&query=inprogres" style="color: #516377">
                                        <h5 class="mb-0">
                                ...
                                <td>
                                    <a href="index.php?pagename=searchdisplay_customermaster&customerid=<?php echo $customer_id ?>&query=delivered" style="color: #516377">
                                        <h5 class="mb-0">
                                            <?php echo $doorMade ?>
                                        </h5>
                                        <span>Door Made</span>
        ...
        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
            ...
            <div class="col-md" style="margin-top: -15px">
                <div class="accordion mt-3 accordion-header-primary" id="accordionWithIcon" >
                        ...
                        <div id="accordionWithIcon-1" class="accordion-collapse collapse show">
                            <div class="accordion-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>Packing Note</td>
                                        <td><b><?php echo $master_result["packingnote"] ?></b></td>
                                        <td>Location</td>
                    ...
                    <div class="accordion-item card" style="margin-top: -15px;">
                        <h2 class="accordion-header d-flex align-items-center">
                        ...
                        <div id="accordionWithIcon-2" class="accordion-collapse collapse">
                            <div class="accordion-body">
                                <div class="table-responsive mb-2" style="max-height: 400px;overflow-y: auto;border-bottom: solid 1px #d4d8dd">
                                    <table class="table table-bordered">
                        ...
                        <div class="accordion-item card">
                            <h2 class="accordion-header d-flex align-items-center">
                                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordionWithIcon-3" aria-expanded="false" >
                                    ...
                                    New Orders Orders for&nbsp;<b><?php echo $customer["cust_companyname"] ?></b>
                                </button>
                            </h2>
                            <div id="accordionWithIcon-3" class="accordion-collapse collapse">
                                <div class="accordion-body">
