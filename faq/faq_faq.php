                ...
                <ul class="nav nav-align-left nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#product">
                            ...
                            <span class="align-middle">Label Values Setting</span>
                        </button>
                    </li>
                </ul>
            ...
            <div class="tab-content py-0">
                <div class="tab-pane fade show active" id="payment" role="tabpanel">
                    <div class="d-flex mb-3 gap-3">
                        ...
                        <div>
                            <h5 class="mb-0">
                                <span class="align-middle">Dashboard Pages Search</span>
                            </h5>
                            <span>A dashboard is a way of displaying various types of visual data in one place. Usually, a dashboard is intended to convey different, but related information in an easy-to-digest form.</span>
                        </div>
                    </div>
                        ...
                        <div class="card accordion-item active">
                            <h2 class="accordion-header">
                                <button
                                    ...
                                    >
                                    Q1: How I can search PVC Live chart
                                </button>
                            </h2>

                            <div id="accordionPayment-1" class="accordion-collapse collapse show">
                                <div class="accordion-body">
                                    <a href="index.php?pagename=workstationload_dashboard">Click Here</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card accordion-item">
                            <h2 class="accordion-header">
                                <button
                                    ...
                                    >
                                    Q1: How I can search Laminate Live chart
                                </button>
                            </h2>
    ...
    <div class="row text-center justify-content-center gap-sm-0 gap-3">
        <div class="col-sm-6">
            <div class="py-3 rounded bg-faq-section text-center">
                ...
                <h4 class="mb-2"><a class="h4" href="tel:+(91)7416363492">+ (91) 7416363492</a></h4>
        ...
        <div class="col-sm-6">
            <div class="py-3 rounded bg-faq-section text-center">
                ...
                <h4 class="mb-2"><a class="h4" href="mailto:eew.pravin@gmail.com">eew.pravin@gmail.com</a></h4>
