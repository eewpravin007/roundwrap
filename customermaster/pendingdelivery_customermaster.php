...
<div class="card md-12">
    <div class="card-header" >
        <div class="alert alert-danger" role="alert">
            <b><i>Order moved from production out but not delivered to customer</i></b>
        </div>

        <div style="float: left">
            <a href="index.php?pagename=pendingdelivery_customermaster&category=PVC" 
               class="btn btn-label-dark <?php echo $category == "PVC" ? "active" : "" ?>">PVC</a>
            &nbsp;
            <a href="index.php?pagename=pendingdelivery_customermaster&category=LAMINATE" 
               class="btn btn-label-dark <?php echo $category == "LAMINATE" ? "active" : "" ?>">LAMINATE</a>

            &nbsp;
            <a href="exportdata/export_pendingdelivery.php?category=<?php echo $category ?>" 
               class="btn btn-label-dark"
               target="_blank">
                    ...
                    foreach ($master_result as $value) {
                        ...
                        <tr style="">
                            <td><?php echo $index01++ ?></td>
                             <td>
                                <a title="Create Note" href="index.php?pagename=create_notes&search_order=<?php echo $value["so_no"] ?>&criteria=pendingdel">
