<?php
$customer_dropdown = Customer::getCustomerNameAndOtherDetails();
?>
<style>
...
<div class="card md-12">
    <h5 class="card-header">Excellent!!!.. Check yours customer details and orders</h5>
    ...
    <div class="card-body" style="margin-top: -20px">
        ...
        <div style="float: right">
            <a href="exportdata/export_customerdata.php" target="_blank">
